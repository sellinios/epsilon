...
function Footer() {
  ...
  return (
    <>
      {showCookieConsent && (
        <div className="cookie-consent text-white py-3 px-4">
          <p className="mb-0">
      ...
      <footer className="footer text-white">
        <div className="container py-5">
          {/* First Level: Contact Information and Global Presence */}
